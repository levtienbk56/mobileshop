                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?php echo base_url(); ?>admin/index.php/login/do_logout" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>admin/index.php"><i class="fa fa-angle-double-right"></i>Danh sách sản phẩm</a></li>
                                <li><a href="<?php echo base_url(); ?>admin/index.php"><i class="fa fa-angle-double-right"></i>Nhãn hiệu</a></li>
                                <li><a href="<?php echo base_url(); ?>admin/index.php"><i class="fa fa-angle-double-right"></i> Nhóm sản phẩm</a></li>
