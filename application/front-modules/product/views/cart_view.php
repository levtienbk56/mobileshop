...
<?php } else { ?>
    ...
    <form id="ajaxform" action="<?php echo base_url(); ?>index.php/product/view_cart" method="post" >
        ...
        <!--                <td style="text-align:center;"><input class="form-control text-center soluongmua"  name="<?php echo $i . '[qty]'; ?>" value="<?php echo $items['qty']; ?>" ></td>-->

                    <td>
                        <select name="<?php echo $i . '[qty]'; ?>" class="text-center soluongmua" style="margin-left:50px;">
