...
<!--                    <a href="<?php echo base_url(); ?>index.php/product/delete_item_in_cart/<?php echo $items['id']; ?>"><i class="icon-trash"></i></a>-->
                    <a href="<?php echo base_url(); ?>index.php/product/updatecart"><i class="icon-trash"></i></a>
    ...
    <div class="main-cart-total">
        <p class="total">Tổng cộng <span><?php echo $this->cart->format_number($this->cart->total() * 1000000, 0, ".", $thousands_sep = " ") . " VND";
        ;
        ?></span> 
        </p></div>      
