      ...
      <div class="span12">
         ...
         <div class="flexslider">
            ...
            <ul class="flex-direction-nav">
               <li><a class="flex-prev" href="#"><i class="icon-angle-left vitriPrev"></i></a></li>
               <li><a class="flex-next" href="#"><i class="icon-angle-right vitriNext"></i></a></li>
            </ul>
            ...
            <ul class="flex-direction-nav">
               <li><a class="flex-prev " href="#"><i class="icon-angle-left vitriPrev"></i></a></li>
               <li><a class="flex-next " href="#"><i class="fa-arrow-left vitriNext"></i></a></li>
            </ul>
         </div>
      </div>
   </div>
