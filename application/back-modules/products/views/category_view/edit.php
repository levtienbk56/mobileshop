<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <a style="margin-top: -6px; margin-left: 30px;" href="<?php echo base_url(); ?>admin/index.php/products/categories/addNew" class="btn bg-olive margin" >Thêm mới</a>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <!-- main form -->
            <?php $action_link = base_url() . "admin/index.php/products/categories/update" ?>
            <form role="form" action="<?php echo $action_link; ?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <input type="hidden" name="categoryID" value="<?php echo $category->categoryID ?>">
                    <div class="form-group">
                        <label >Tên danh mục </label>
                        <input class="form-control" name="category_name" type="text" value="<?php echo $category->categoryName; ?>">
                    </div>
                    ...
                    <div class="form-group">                                
                        ...
                        <input type="hidden" id="img_content" name="category_image" value="<?php echo $category->image; ?>">
                        <br>
                        <h5>Thay đổi ảnh?</h5>
                        ...
                        <div class='box'>
                            ...
                            <div class='box-body pad'>                                    
                                <textarea id="CKEditor" name="category_description"  rows="10" cols="80"><?php echo $category->description; ?></textarea>
                            </div>
                        </div>
